...
| 07-28 17:24 | D-018 | Task2 方法比较当前推荐 Ridge 回归后分档：验证集 ACC=0.8340、Macro-F1=0.8244、MAE=0.1660，优于直接 Logistic | B | C | 待复核 |
| 07-28 17:24 | D-019 | D28-04 采用严格三任务聚合门禁；A/C 产物不齐时不生成全任务比较、调参或消融汇总 | B | C | 已执行 |
